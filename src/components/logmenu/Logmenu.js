...
<div className={classes.methods}>
        ...
        <Grid container spacing={0} className={classes.methodbtns}>
          ...
          <Grid item xs={4}>
            <Button
              variant={logmenumethod === "guest" ? "contained" : "outlined"}
              disableElevation
              className={classes.methodbtn}
              onClick={() => setLogmenuMethod("guest")}
            >
              Guest
            </Button>
          </Grid>
          <Grid item xs={4}>
            <Button
              disabled={true}
              variant={logmenumethod === "google" ? "contained" : "outlined"}
              disableElevation
              className={classes.methodbtn}
              onClick={() => setLogmenuMethod("google")}
            >
              Google
            </Button>
          </Grid>
          <Grid item xs={4}>
            <Button
              disabled={true}
              variant={logmenumethod === "email" ? "contained" : "outlined"}
              disableElevation
              className={classes.methodbtn}
              onClick={() => setLogmenuMethod("email")}
            >
              Email
            </Button>
          </Grid>
